...
const getNativeSelection = rootNode => {
  try {
...
class Selection {
  ...
  getNativeRange() {
    ...
    const getNativeRange = rootNode => {
      ...
      if (!isSafari && selection && 'getComposedRanges' in selection && typeof selection.getComposedRanges === 'function' &&
  ...
  hasFocus() {
    ...
    return doc.activeElement === this.root || doc.activeElement != null && contains(this.root, doc.activeElement);
  }
  ...
  setNativeRange(startNode, startOffset) {
    ...
    const selection = getNativeSelection(this.rootDocument);
